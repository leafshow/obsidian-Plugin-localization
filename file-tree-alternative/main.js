...
class FileTreeAlternativePluginSettingsTab extends obsidian.PluginSettingTab {
    ...
    display() {
        ...
        new obsidian.Setting(containerEl)
            .setName('Evernote 视图')
            .setDesc('开启后可以在单个视图中查看文件夹和文件,无需在视图之间切换。类似 Evernote 的浏览体验。')
        ...
        new obsidian.Setting(containerEl)
            ...
            .setDesc('启用后可以从核心书签插件中显示文件或文件夹。由于目前没有 API 可以覆盖书签插件的默认行为,这将添加一个事件,按住 shift 点击书签名称时可以显示文件。')
        ...
        new obsidian.Setting(containerEl)
            .setName('显示根文件夹')
            .setDesc(`开启后,您的根文件夹 "${this.plugin.app.vault.getName()}" 将在文件树中可见`)
        ...
        new obsidian.Setting(containerEl)
            .setName('文件夹笔记')
            .setDesc(`开启此选项后,可以像文件夹笔记插件一样创建文件夹笔记。
        ...
        new obsidian.Setting(containerEl)
            ...
            .setDesc(`开启此项后,除了选定的文件夹外,还可以查看所有子文件夹中的文件列表`)
        ...
        new obsidian.Setting(containerEl)
            ...
            .setDesc(`开启此项后,将在文件列表顶部添加一个额外的按钮来切换 "包含子文件夹文件"`)
        ...
        new obsidian.Setting(containerEl)
            ...
            .setDesc(`开启此项后,将添加一个额外的按钮来在文件树中显示当前文件。它将相应地设置文件夹和文件面板。`)
        ...
        new obsidian.Setting(containerEl)
            ...
            .setDesc(`"all:" 和 "tag:" 搜索默认会在您的 vault 中查找所有文件。开启此项后,仅在聚焦文件夹中进行搜索`)
        ...
        new obsidian.Setting(containerEl)
            .setName('悬停预览文件')
            .setDesc('开启后,在文件列表中按住 Ctrl/Cmd 按钮悬停在文件上时可以预览文件。')
        ...
        new obsidian.Setting(containerEl)
            .setName('隐藏附件')
            .setDesc(`这将从视图中隐藏 "attachments" 文件夹,并在文件列表中隐藏该文件夹下的任何文件`)
        ...
        new obsidian.Setting(containerEl)
            .setName('排除的文件扩展名')
            .setDesc(`提供要从文件树列表中排除的文件扩展名,用逗号分隔。例如:'png, pdf, jpeg'。
        ...
        new obsidian.Setting(containerEl)
            .setName('排除的文件夹路径')
            .setDesc(`提供要从文件树列表中排除的文件夹完整路径,用逗号分隔。例如:'Personal/Attachments, Work/Documents/Folders'。
        ...
        new obsidian.Setting(containerEl)
            .setDesc('使用此按钮重新加载文件树。某些设置需要重新加载文件树。您也可以重新启动您的 vault 以达到相同的效果。')
            .addButton((button) => {
            button
        ...
        new obsidian.Setting(containerEl)
            .setName('清除所有缓存数据')
            .setDesc(`此按钮将清除以下缓存数据:"分隔符的最后位置"、"文件夹面板中已展开文件夹的列表"和"最后活动的文件夹路径"。它不会影响上面的设置和已固定的文件列表。建议偶尔执行此清除操作。`)
            .addButton((button) => {
            button
