...
var COMMON_MIME_TYPES = new Map([
  ...
  ["zip", "application/zip"],
  ["7z", "application/x-7z-compressed"], // Others
    ...
    var acceptForPicker = Object.entries(accept)
      ...
      .reduce(function (agg, _ref4) {
        ...
        return _objectSpread$1(
          _objectSpread$1({}, agg),
          {},
          _defineProperty$2({}, mimeType, ext),
        );
      }, {});
    return [
      {
    ...
    return Object.entries(accept)
      .reduce(function (a, _ref6) {
        var _ref7 = _slicedToArray$1(_ref6, 2),
          ...
          ext = _ref7[1];
        return [].concat(
          _toConsumableArray$2(a),
          [mimeType],
          _toConsumableArray$2(ext),
        );
 ...
 */ var Dropzone = /*#__PURE__*/ reactExports.forwardRef(function (_ref, ref) {
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    null,
    children(_objectSpread(_objectSpread({}, props), {}, { open: open })),
  );
});
 ...
 */ function useDropzone() {
  ...
  var acceptAttr = reactExports.useMemo(
    function () {
      return acceptPropAsAcceptAttr(accept);
    },
    [accept],
  );
  var pickerTypes = reactExports.useMemo(
    function () {
      return pickerOptionsFromAccept(accept);
    },
    [accept],
  );
  var onFileDialogOpenCb = reactExports.useMemo(
    function () {
      return typeof onFileDialogOpen === "function" ? onFileDialogOpen : noop;
    },
    [onFileDialogOpen],
  );
  var onFileDialogCancelCb = reactExports.useMemo(
    function () {
  ...
  var fsAccessApiWorksRef = reactExports.useRef(
    typeof window !== "undefined" &&
  ...
  var onErrCb = reactExports.useCallback(
    function (e) {
      if (onError) {
        onError(e);
      } else {
  ...
  var onDragEnterCb = reactExports.useCallback(
    function (event) {
      event.preventDefault(); // Persist here because we need the event later after getFilesFromEvent() is done
      event.persist();
      stopPropagation(event);
      dragTargetsRef.current = [].concat(
        _toConsumableArray$1(dragTargetsRef.current),
        [event.target],
      );
  ...
  var onDragOverCb = reactExports.useCallback(
    function (event) {
      event.preventDefault();
      event.persist();
      stopPropagation(event);
  ...
  var onDragLeaveCb = reactExports.useCallback(
    function (event) {
      event.preventDefault();
      event.persist();
  ...
  var setFiles = reactExports.useCallback(
  ...
  var onDropCb = reactExports.useCallback(
    function (event) {
      event.preventDefault(); // Persist here because we need the event later after getFilesFromEvent() is done
      event.persist();
      stopPropagation(event);
  ...
  var openFileDialog = reactExports.useCallback(
    function () {
      ...
      if (fsAccessApiWorksRef.current) {
        ...
        var opts = { multiple: multiple, types: pickerTypes };
        window
  ...
  var onKeyDownCb = reactExports.useCallback(
    function (event) {
  ...
  var onClickCb = reactExports.useCallback(
    function () {
      if (noClick) {
        return;
  ...
  var getRootProps = reactExports.useMemo(
    function () {
      return function () {
        var _ref2 =
            arguments.length > 0 && arguments[0] !== undefined
  ...
  var getInputProps = reactExports.useMemo(
    function () {
      return function () {
        var _ref3 =
            arguments.length > 0 && arguments[0] !== undefined
 ...
 */ function reducer(state, action) {
  /* istanbul ignore next */ switch (action.type) {
    case "focus":
      return _objectSpread(_objectSpread({}, state), {}, { isFocused: true });
    case "blur":
      return _objectSpread(_objectSpread({}, state), {}, { isFocused: false });
    case "openDialog":
      return _objectSpread(
...
// THIS FILE IS AUTO GENERATED
function MdOutlineCreateNewFolder(props) {
  return GenIcon({
    tag: "svg",
    attr: { viewBox: "0 0 24 24" },
    child: [
...
var stripIndents = new TemplateTag(
...
const createNewMarkdownFile = (plugin, folder, newFileName, content) =>
  __awaiter(void 0, void 0, void 0, function* () {
    // @ts-ignore
    const newFile = yield plugin.app.fileManager.createNewMarkdownFile(
      folder,
      newFileName,
    );
    if (content && content !== "")
  ...
  onOpen() {
    ...
    if (this.action === "rename") {
      ...
      if (this.file.path.endsWith(".md")) {
        if (
          this.file instanceof obsidian.TFolder ||
          this.file instanceof obsidian.TAbstractFile
        ) {
        ...
        if (this.action === "rename") {
          ...
          if (this.file.path.endsWith(".md")) {
            newName =
              newName +
              "." +
              this.file.path.slice(this.file.path.lastIndexOf(".") + 1);
          }
          // Folder Note files to be updated
          if (
            this.file instanceof obsidian.TFolder &&
            this.plugin.settings.folderNote
          ) {
            let folderNoteFile = this.app.vault.getAbstractFileByPath(
              this.file.path + "/" + this.file.name + ".md",
            );
            if (folderNoteFile)
              this.app.fileManager.renameFile(
                folderNoteFile,
                this.file.path + "/" + newName + ".md",
              );
          }
          ...
          yield createNewMarkdownFile(
            this.plugin,
            this.file,
            newName,
            this.plugin.settings.createdYaml
              ? getFileCreateString({ plugin: this.plugin, fileName: newName })
              : "",
          );
        }
        myModal.close();
...
const getFilesUnderPath = (params) => {
  const { path, plugin, getAllFiles, excludedExtensions, excludedFolders } =
    params;
  var filesUnderPath = [];
  var showFilesFromSubFolders = getAllFiles
    ? true
      ...
      for (let child of folderObj.children) {
        if (child instanceof obsidian.TFile) {
          if (
            ...
            (plugin.settings.hideAttachments &&
              child.path
                .toLowerCase()
                .includes(
                  plugin.settings.attachmentsFolderName.toLowerCase(),
                )) ||
  ...
  function recursive(folder, object) {
    ...
    for (let child of folder.children) {
      if (child instanceof obsidian.TFolder) {
        ...
        if (
          (plugin.settings.hideAttachments &&
            childFolder.name === plugin.settings.attachmentsFolderName) ||
...
const getFolderNoteCountMap = (plugin) => {
  ...
  if (plugin.settings.folderNote) {
    files = files.filter(
      (f) =>
        f.extension !== "md" ||
        (f.extension === "md" && f.basename !== f.parent.name),
    );
  }
  files.forEach((file) => {
...
const hasChildFolder = (folder) => {
  ...
  for (let child of children) {
    if (child instanceof obsidian.TFolder) return true;
  }
  return false;
};
...
const internalPluginLoaded = (pluginName, app) => {
  var _a;
  // @ts-ignore
  return (_a = app.internalPlugins.plugins[pluginName]) === null ||
    _a === void 0
    ? void 0
    : _a._loaded;
};
...
const createNewFile = (e, folderPath, plugin) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const LoadableStaticInterface = {
  ...
  error: (error) => loadableWithError(error), // $FlowIssue[incompatible-return]
...
const env = {
  RECOIL_DUPLICATE_ATOM_KEY_CHECKING_ENABLED: true, // Note: RECOIL_GKS_ENABLED settings will only be honored in OSS builds of Recoil
...
var Recoil_PersistentMap = { persistentMap };
...
var Recoil_Graph = { cloneGraph, graph: makeGraph, saveDepsToStore };
/**
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 *
 * This source code is licensed under the MIT license found in the
...
var Recoil_RetentionZone = { RetentionZone, retentionZone };
/**
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 *
 * This source code is licensed under the MIT license found in the
...
const { setByAddingToSet: setByAddingToSet$1 } = Recoil_CopyOnWrite; // flowlint-next-line unclear-type:off
...
function peekNodeInfo(store, state, key) {
  ...
  return Recoil_lazyProxy(
    { type },
    {
      ...
      isModified: () => state.dirtyAtoms.has(key), // Report current dependencies.  If the node hasn't been evaluated, then
...
function markRecoilValueModified(store, recoilValue) {
  queueOrPerformStateUpdate(store, { type: "markModified", recoilValue });
}
...
const { RetentionZone: RetentionZone$2 } = Recoil_RetentionZone; // Components that aren't mounted after suspending for this long will be assumed
...
var ReactBatchedUpdates = { unstable_batchedUpdates }; /**
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
...
var Recoil_Batching = { getBatcher, setBatcher, batchUpdates };
/**
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 *
 * This source code is licensed under the MIT license found in the
...
/* eslint-enable fb-www/typeof-undefined */ const isWindow = (value) =>
...
class Snapshot {
  ...
  /* eslint-disable fb-www/extra-arrow-initializer */ /* eslint-enable fb-www/extra-arrow-initializer */
}
...
const AppContext = /*#__PURE__*/ React.createContext({ current: defaultStore });
const useStoreRef = () => useContext(AppContext); // $FlowExpectedError[incompatible-call]
const MutableSourceContext = /*#__PURE__*/ React.createContext(null);
  ...
  initializeState({
    set: (atom, value) => {
      ...
      initial.currentTree = {
        ...
        atomValues: applyAtomValueWrites$1(state.atomValues, writes), // NB: PLEASE un-export applyAtomValueWrites when deleting this code
        nonvalidatedAtoms,
      };
    },
...
const { isSSR: isSSR$2 } = Recoil_Environment; // I don't see a way to avoid the any type here because we want to accept readable
...
*/ function useRecoilValueLoadable(recoilValue) {
  ...
  return {
    TRANSITION_SUPPORT: useRecoilValueLoadable_TRANSITION_SUPPORT, // Recoil will attemp to detect if `useSyncExternalStore()` is supported with
...
var Recoil_AtomicUpdates = { atomicUpdater };
...
var Recoil_useRecoilCallback = { recoilCallback, useRecoilCallback };
...
var Recoil_Wrapper = { WrappedValue };
...
var Recoil_TreeCache = { TreeCache };
...
class LRUCache {
  ...
  set(key, val) {
    ...
    const node = { key, right: head, left: null, value: val };
    if (head) {
      head.left = node;
    } else {
      this._tail = node;
...
function getTreeCache(eviction, maxSize, mapNodeValue, name) {
  switch (eviction) {
    case "keep-all":
      return new TreeCache$2({ name, mapNodeValue });
    case "lru":
    ...
    case "most-recent":
      return Recoil_treeCacheLRU({ name, maxSize: 1, mapNodeValue });
  }
...
/* eslint-disable no-redeclare */ function selector(options) {
  ...
  function evaluateSelectorGetter(store, state, executionID) {
    ...
    let loadable;
    const loadingDepsState = { loadingDepKey: null, loadingDepPromise: null };
    /**
    ...
    const getCallback = (fn) => {
      return (...args) => {
        ...
        return recoilCallback$1(
          ...
          fn,
          args,
          { node: recoilValue }, // flowlint-line unclear-type:off
        );
      };
    };
    try {
...
function getCache(eviction, maxSize, mapKey) {
  switch (eviction) {
    case "keep-all":
      return new MapCache$1({ mapKey });
    case "lru":
      return new LRUCache$2({ mapKey, maxSize: Recoil_nullthrows(maxSize) });
    case "most-recent":
      return new LRUCache$2({ mapKey, maxSize: 1 });
  }
  throw Recoil_err(`Unrecognized eviction policy ${eviction}`);
}
...
// @fb-only: params,
// @fb-only: ),
});atomCache.set(params,newAtom);setConfigDeletionHandler$2(newAtom.key,()=>{atomCache.delete(params);});return newAtom;};}
var Recoil_atomFamily = atomFamily;
const { setConfigDeletionHandler: setConfigDeletionHandler$3 } = Recoil_Node; // Keep in mind the parameter needs to be serializable as a cahche key
...
/* eslint-enable no-redeclare */ var Recoil_selectorFamily = selectorFamily; // flowlint-next-line unclear-type:off
...
var Recoil_index = {
  ...
  RecoilLoadable, // Global Recoil environment settiongs
  RecoilEnv: Recoil_RecoilEnv, // Recoil Root
  RecoilRoot: RecoilRoot$2,
  useRecoilStoreID: useRecoilStoreID$1,
  useRecoilBridgeAcrossReactRoots_UNSTABLE:
    Recoil_useRecoilBridgeAcrossReactRoots, // Atoms/Selectors
  atom: Recoil_atom,
  selector: Recoil_selector, // Convenience Atoms/Selectors
  atomFamily: Recoil_atomFamily,
  selectorFamily: Recoil_selectorFamily,
  constSelector: Recoil_constSelector,
  errorSelector: Recoil_errorSelector,
  readOnlySelector: Recoil_readOnlySelector, // Concurrency Helpers for Atoms/Selectors
  noWait: noWait$1,
  waitForNone: waitForNone$1,
  waitForAny: waitForAny$1,
  waitForAll: waitForAll$1,
  waitForAllSettled: waitForAllSettled$1, // Hooks for Atoms/Selectors
  useRecoilValue: useRecoilValue$1,
  useRecoilValueLoadable: useRecoilValueLoadable$1,
  useRecoilState: useRecoilState$1,
  useRecoilStateLoadable: useRecoilStateLoadable$1,
  ...
  useRecoilValue_TRANSITION_SUPPORT_UNSTABLE:
    useRecoilValue_TRANSITION_SUPPORT_UNSTABLE$1,
  useRecoilState_TRANSITION_SUPPORT_UNSTABLE:
    useRecoilState_TRANSITION_SUPPORT_UNSTABLE$1, // Hooks for complex operations
  useRecoilCallback: useRecoilCallback$1,
  useRecoilTransaction_UNSTABLE: Recoil_useRecoilTransaction, // Snapshots
  useGotoRecoilSnapshot: useGotoRecoilSnapshot$1,
  useRecoilSnapshot: useRecoilSnapshot$1,
  useRecoilTransactionObserver_UNSTABLE: useRecoilTransactionObserver$1,
  snapshot_UNSTABLE: freshSnapshot$2, // Memory Management
...
const getFilesWithName = (params) => {
  ...
  var filteredFiles = files.filter((file) =>
    file.basename
      .toLowerCase()
      .includes(searchPhrase.toLowerCase().trimStart()),
  );
...
const getFilesWithTag = (params) => {
  ...
  let ozFiles = getFilesUnderPath({
    path: plugin.settings.allSearchOnlyInFocusedFolder
      ? focusedFolder.path
      : "/",
    plugin: plugin,
    excludedExtensions: excludedExtensions,
...
const sortedFiles = (params) => {
  ...
  sortedfileList = sortedfileList.sort((a, b) => {
    if (
      ozPinnedFiles.some((f) => f.path === a.path) &&
      !ozPinnedFiles.some((f) => f.path === b.path)
    ) {
      return -1;
    } else if (
      !ozPinnedFiles.some((f) => f.path === a.path) &&
...
const sortFileListClickHandle = (params) => {
  ...
  const addMenuItem = (label, low, high, value) => {
    sortMenu.addItem((menuItem) => {
      const order = plugin.settings.sortReverse
        ? `${high} to ${low}`
        : `${low} to ${high}`;
      menuItem.setTitle(`${label} (${order})`);
      menuItem.setIcon(
        value === plugin.settings.sortFilesBy ? "checkmark" : "spaceIcon",
      );
...
const handleSearch = (params) => {
  ...
  if (tagRegexMatch) {
    ...
    if (
      tagRegexMatch[1] === undefined ||
      tagRegexMatch[1].replace(/\s/g, "").length === 0
    ) {
      setOzFileList([]);
      return;
    }
  ...
  if (allRegexMatch) {
    ...
    searchFolder = plugin.settings.allSearchOnlyInFocusedFolder
      ? focusedFolder.path
      : "/";
...
const triggerContextMenu = (params) => {
  ...
  fileMenu.addItem((menuItem) => {
    ...
    const isAlreadyPinned = ozPinnedFiles.some(
      (pinnedFile) => pinnedFile.path === file.path,
    );
    if (isAlreadyPinned) menuItem.setTitle("已固定");
    else menuItem.setTitle("固定到顶部");
    menuItem.onClick((ev) => {
      if (isAlreadyPinned) {
        let newPinnedFiles = ozPinnedFiles.filter(
          (pinnedFile) => pinnedFile.path !== file.path,
        );
...
var u = (n, t, e) =>
  t in n
    ? h(n, t, { enumerable: !0, configurable: !0, writable: !0, value: e })
    : (n[t] = e);
var c = (n, t, e) => (u(n, typeof t != "symbol" ? t + "" : t, e), e);
const p = (n, t) =>
    typeof getComputedStyle < "u"
      ? getComputedStyle(n, null).getPropertyValue(t)
      : n.style.getPropertyValue(t),
  y = (n) => p(n, "overflow") + p(n, "overflow-y") + p(n, "overflow-x"),
  w = (n) => {
...
class g extends reactExports.Component {
  constructor(e) {
    super(e);
    ...
    c(this, "lazyLoadHandler", (e) => {
      ...
      if (l) {
        ...
        a &&
          ...
          ((i = this.elementObserver) == null || i.unobserve(a));
      }
    });
  ...
  componentDidMount() {
    var o;
    this.getEventNode();
    const { offset: e, threshold: s } = this.props,
      r = {
  ...
  componentWillUnmount() {
    ...
    e &&
      ...
      ((r = this.elementObserver) == null || r.unobserve(e));
  }
  getEventNode() {
    var e;
  ...
  render() {
    ...
    return /*#__PURE__*/ reactExports.createElement(
      o || "div",
      { className: d, style: a, ref: this.wrapper },
      i && reactExports.Children.only(e),
    );
  }
}
c(g, "defaultProps", {
...
function FileComponent(props) {
  ...
  const [activeFolderPath$1, setActiveFolderPath] =
    Recoil_index_22(activeFolderPath);
  ...
  const [treeHeader, setTreeHeader] = reactExports.useState(
    getFolderName(activeFolderPath$1, plugin.app),
  );
  // Force Update
  ...
  const filesToList = reactExports.useMemo(
    () =>
      sortedFiles({
    ...
    [
      ...
      ozPinnedFiles,
      ozFileList$1,
      plugin.settings.sortFilesBy,
      plugin.settings.sortReverse,
    ],
  );
                ...
                React.createElement(
                  ...
                  plugin.settings.revealActiveFileButton &&
                    React.createElement(
                      ...
                      React.createElement(BiCurrentLocation, {
                        onClick: () => handleRevealActiveFileButton({ plugin }),
                        size: topIconSize,
                  ...
                  plugin.settings.showFilesFromSubFoldersButton &&
                    React.createElement(
                      ...
                      { className: "oz-nav-action-button" },
                      showSubFolders$1
                        ? React.createElement(IoIosEyeOff, {
                  ...
                  React.createElement(
                    ...
                    React.createElement(IoIosAddCircle, {
                      onClick: (e) =>
                        createNewFile(e, activeFolderPath$1, plugin),
                      size: topIconSize,
...
const NavFile = (props) => {
    ...
    const handleKeyDownEvent = (e) => {
      if (e.key === "Control" || e.key === "Meta") {
        let el = document.querySelector(
          `.oz-nav-file-title[data-path="${file.path}"]`,
        );
        if (el)
          plugin.app.workspace.trigger(
            "link-hover",
  ...
  const FileIcon = reactExports.useMemo(
    () =>
      getFileIcon({
        file,
      }),
  ...
  const fileDisplayName = reactExports.useMemo(() => {
    return plugin.settings.showFileNameAsFullPath
      ? getFileNameAndExtension(file.path).fileName
      : file.basename;
    ...
    Object.assign(
      {
        className:
          "oz-nav-file" +
          (activeOzFile && activeOzFile.path === file.path ? " is-active" : ""),
        key: file.path,
        draggable: true,
        onDragStart: (e) =>
          dragStarted({
        ...
        onAuxClick: (e) => onAuxClick({ e, plugin, file }),
        onContextMenu: (e) =>
          triggerContextMenu({
            e,
            file,
        ...
        onMouseLeave: (e) => mouseLeftFile({ e, file, setHoverActive }),
      },
      longPressEvents,
    ),
    React.createElement(
      "div",
      { className: "oz-nav-file-title", "data-path": file.path },
      React.createElement(
        "div",
      ...
      ozPinnedFiles.some((f) => f.path === file.path) &&
...
function Tree(props) {
  ...
  const toggle = () => {
    if (props.children) {
      ...
      if (!open) {
        ...
        const newOpenFolders = openFolders$1.filter(
  ...
  const onDrop = (files) => {
    files.map((file) =>
      __awaiter(this, void 0, void 0, function* () {
        file.arrayBuffer().then((arrayBuffer) => {
          props.plugin.app.vault.adapter.writeBinary(
  ...
  const Icon = reactExports.useMemo(
    () => getFolderIcon(props.plugin, props.children, open),
    [open, props.children, props.plugin.settings.folderIcon],
  );
  // --> Folder Count Map
  ...
  const onFolderDragStart = (e, folder) => {
    e.dataTransfer.setData(
      "application/json",
      JSON.stringify({ folderPath: folder.path }),
    );
    ...
    ({ getRootProps, getInputProps }) =>
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            "div",
            Object.assign({}, getRootProps({ className: "dropzone" }), {
              className:
                "oz-folder-element" + (highlight ? " drag-entered" : ""),
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(Icon, {
                  ...
                  style: { opacity: props.children ? 1 : 0.3 },
                  onClick: toggle,
                }),
              ),
              React.createElement(
                ...
                React.createElement(
                  "div",
                  {
                    ...
                    style: { marginRight: props.type ? 10 : 0 },
                  },
                  props.type,
                ),
                React.createElement(
                  ...
                  props.content,
                  " ",
                  props.plugin.settings.folderNote &&
                    props.folder.children.some(
                      (f) => f.name === `${props.folder.name}.md`,
                    )
                    ? React.createElement(IoMdArrowDropright, {
                        size: 10,
...
const ConditionalRootFolderWrapper = ({ condition, wrapper, children }) =>
...
function NestedFolders(props) {
  ...
  const [activeFolderPath$1, setActiveFolderPath] =
    Recoil_index_22(activeFolderPath);
  const [excludedFolders$1, setExcludedFolders] =
    Recoil_index_22(excludedFolders);
  ...
  const getSortedFolderTree = (folderTree) => {
    ...
    newTree = newTree.sort((a, b) => {
      if (plugin.settings.sortFoldersBy === "name") {
        ...
        let aCount = folderFileCountMap$1[a.folder.path]
          ? folderFileCountMap$1[a.folder.path].closed
          : 0;
        let bCount = folderFileCountMap$1[b.folder.path]
          ? folderFileCountMap$1[b.folder.path].closed
          : 0;
  ...
  const handleFolderContextMenu = (params) => {
    ...
    let folderNoteExists = folder.children.some(
      (f) => `${folder.name}.md` === f.name,
    );
    if (folderNoteExists) {
      folderMenu.addItem((menuItem) => {
        menuItem
          ...
          menuItem
            ...
            .onClick((ev) => {
              const folderNoteFile =
                plugin.app.vault.getAbstractFileByPath(folderNotePath);
  ...
  let sortedFolderTree = reactExports.useMemo(
    () => getSortedFolderTree(props.folderTree.children),
    [
      props.folderTree.children,
      excludedFolders$1,
      plugin.settings.sortFoldersBy,
    ],
  );
  return React.createElement(
    React.Fragment,
...
function MainFolder(props) {
  ...
  // Global States
  const [_activeFolderPath, setActiveFolderPath] =
    Recoil_index_22(activeFolderPath);
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      {
        condition:
          (focusedFolder$1 && !focusedFolder$1.isRoot()) ||
          (focusedFolder$1 &&
            focusedFolder$1.isRoot &&
        ...
        wrapper: (children) => {
          return React.createElement(
            ...
            {
              plugin: plugin,
              content: focusedFolder$1.isRoot()
                ? plugin.app.vault.getName()
                : focusedFolder$1.name,
              open: true,
              ...
              onContextMenu: (e) =>
                handleRootFolderContextMenu(e, focusedFolder$1),
            },
            children,
          );
        },
  ...
  reactExports.useEffect(() => {
    if (folderPaneHeight) {
      localStorage.setItem(
        plugin.keys.customHeightKey,
        folderPaneHeight.toString(),
      );
    }
  }, [folderPaneHeight]);
  function touchMouseStart(e) {
    if (e.type !== "drag" && e.target.id !== "file-tree-divider") return;
    e.preventDefault();
...
const SingleViewHorizontal = (props) => {
  ...
  reactExports.useEffect(() => {
    if (folderPaneWidth) {
      localStorage.setItem(
        plugin.keys.customWidthKey,
        folderPaneWidth.toString(),
      );
    }
  }, [folderPaneWidth]);
  function touchMouseStart(e) {
    ...
    setDividerOnMove(true);
    let width =
      dividerRef.current.offsetLeft - folderPaneRef.current.offsetLeft;
...
function MainTreeComponent(props) {
  ...
  const [excludedFolders$1, setExcludedFolders] =
    Recoil_index_22(excludedFolders);
  const [_folderFileCountMap, setFolderFileCountMap] =
    Recoil_index_22(folderFileCountMap);
  const [excludedExtensions$1, setExcludedExtensions] =
    Recoil_index_22(excludedExtensions);
  ...
  const setInitialActiveFolderPath = () => {
    if (["Horizontal", "Vertical"].includes(plugin.settings.evernoteView)) {
      let previousActiveFolder = localStorage.getItem(
        plugin.keys.activeFolderPathKey,
      );
      if (previousActiveFolder) {
        let folder =
          plugin.app.vault.getAbstractFileByPath(previousActiveFolder);
  ...
  reactExports.useEffect(() => {
    ...
    return () => {
      ...
      window.removeEventListener(
        eventTypes.revealFolder,
        handleRevealFolderEvent,
      );
      window.removeEventListener(
        eventTypes.createNewNote,
        handleCreateNewNoteEvent,
      );
    };
  }, []);
  ...
  const changeActiveFile = (evt) => {
    ...
    if (file) setActiveOzFile(TFile2OZFile(file));
  };
  // Initial Load
  reactExports.useEffect(() => {
  ...
  function getOpenFoldersFromSettings() {
    let openFolders = [];
    let localStorageOpenFolders = localStorage.getItem(
      plugin.keys.openFoldersKey,
    );
  ...
  function getPinnedFilesFromSettings() {
    let pinnedFiles = [];
    let localStoragePinnedFiles = localStorage.getItem(
      plugin.keys.pinnedFilesKey,
    );
    if (localStoragePinnedFiles) {
      ...
      for (let file of localStoragePinnedFiles) {
        ...
        if (pinnedFile) pinnedFiles.push(TFile2OZFile(pinnedFile));
      }
    }
    return pinnedFiles;
  }
  ...
  function saveOpenFoldersToSettings() {
    ...
    localStorage.setItem(
      plugin.keys.openFoldersKey,
      JSON.stringify(openFoldersToSave),
    );
  }
  ...
  function handleVaultChanges(file, changeType, oldPathBeforeRename) {
    ...
    if (file instanceof obsidian.TFile) {
      ...
      if (["rename", "delete"].contains(changeType)) {
        ...
        const filteredPinnedFiles = currentOzPinnedFiles.filter(
          (f) =>
            f.path !==
            (changeType === "rename" ? oldPathBeforeRename : file.path),
        );
        if (filteredPinnedFiles.length !== currentOzPinnedFiles.length) {
          setOzPinnedFiles([
            ...filteredPinnedFiles,
            ...(changeType === "rename" ? [TFile2OZFile(file)] : []),
          ]);
        }
      }
      // Update current View
      ...
      if (currentView === "file") {
        ...
        if (
          ...
          if (fileInCurrentView) {
            if (changeType === "delete") {
              ...
              setOzFileList([
                ...
                ...(file.parent.path.startsWith(currentActiveFolderPath)
                  ? [TFile2OZFile(file)]
                  : []),
              ]);
              ...
              if (
                changeType === "rename" &&
                currentActiveOZFile &&
                currentActiveOZFile.path === oldPathBeforeRename
              ) {
          ...
          let fileIsCreatedUnderActiveFolder = file.path.match(
            new RegExp(currentActiveFolderPath + ".*"),
          );
    ...
    // Folder Event Handlers
      ...
      if (
        changeType === "rename" &&
        oldPathBeforeRename &&
        currentActiveFolderPath === oldPathBeforeRename
      ) {
  ...
  reactExports.useEffect(() => {
    if (activeOZFile$1 && ozFileList$1.length > 0) scrollToFile(activeOZFile$1);
  }, [ozFileList$1]);
  ...
  const getAllFoldersToOpen = (fileToReveal) => {
    ...
    recursiveFx(
      fileToReveal instanceof obsidian.TFile
        ? fileToReveal.parent
        : fileToReveal,
    );
  ...
  function revealFileInFileTree(ozFileToReveal) {
    const fileToReveal = plugin.app.vault.getAbstractFileByPath(
      ozFileToReveal.path,
    );
  ...
  return React.createElement(
    ...
    view$1 === "folder"
      ...
      : plugin.settings.evernoteView === "Horizontal"
        ? React.createElement(SingleViewHorizontal, { plugin: plugin })
        : plugin.settings.evernoteView === "Vertical"
          ? React.createElement(SingleViewVertical, { plugin: plugin })
          : React.createElement(FileComponent, { plugin: plugin }),
  );
}
...
class FileTreeView extends obsidian.ItemView {
  ...
  getDisplayText() {
    var _a;
    return (_a = this.plugin) === null || _a === void 0
      ? void 0
      : _a.VIEW_DISPLAY_TEXT;
  }
  getIcon() {
    var _a;
    ...
    this.root.render(
      React.createElement(
        ...
        React.createElement(
          Recoil_index_5,
          null,
          React.createElement(MainTreeComponent, {
            fileTreeView: this,
            plugin: this.plugin,
          }),
        ),
...
var LocalStorageHandler_1 = (lib.LocalStorageHandler = void 0);
var LocalStorageHandler = /** @class */ (function () {
  /**
   * @param cacheHours: Default is 24 Hours, specify if you need less or more
   */ function LocalStorageHandler(params) {
    var _this = this;
    this.getTimeStampKey = function (key) {
     ...
     */ this.getFromLocalStorage = function (params) {
      var key = params.key,
        checkCacheHours = params.checkCacheHours,
        cacheHours = params.cacheHours;
      var localData = localStorage.getItem(key);
      var localDataTimeStamp = localStorage.getItem(_this.getTimeStampKey(key));
      if (checkCacheHours !== undefined) {
        if (!checkCacheHours) return localData;
      } // If Local Storage has the data less than cacheHours
      if (cacheHours) _this.cacheHours = cacheHours;
      if (localDataTimeStamp !== null) {
        var dt = new Date(JSON.parse(localDataTimeStamp));
        var hours = Math.abs(new Date().getTime() - dt.getTime()) / 3600000;
        if (hours < _this.cacheHours && localData !== null) {
          return localData;
        }
      }
      return null;
     ...
     */ this.removeFromLocalStorage = function (params) {
      var key = params.key;
      var localData = localStorage.getItem(key);
      if (!localData) return "not-found"; // Delete the key first if found
      localStorage.removeItem(key); // Delete the timestamp if found
      var timestampKey = _this.getTimeStampKey(key);
      var localTimestamp = localStorage.getItem(timestampKey);
      if (localTimestamp) localStorage.removeItem(timestampKey);
      return "success";
    };
    var cacheHours = params.cacheHours;
    this.cacheHours = cacheHours ? cacheHours : 24;
  }
  return LocalStorageHandler;
})();
LocalStorageHandler_1 = lib.LocalStorageHandler = LocalStorageHandler;
...
class FileTreeAlternativePluginSettingsTab extends obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new obsidian.Setting(containerEl)
      .setName("Evernote 视图")
      .setDesc(
        "开启后可以在单个视图中查看文件夹和文件,无需在视图之间切换。类似 Evernote 的浏览体验。",
      )
    ...
    new obsidian.Setting(containerEl)
      .setName("启动时打开")
      .setDesc("关闭后启动 vault 时不会自动打开文件树视图")
      .addToggle((toggle) =>
        toggle
    ...
    new obsidian.Setting(containerEl)
      ...
      .setDesc(
        "启用后可以从核心书签插件中显示文件或文件夹。由于目前没有 API 可以覆盖书签插件的默认行为,这将添加一个事件,按住 shift 点击书签名称时可以显示文件。",
      )
      .addToggle((toggle) =>
        toggle
          .setValue(this.plugin.settings.bookmarksEvents)
          .onChange((value) => {
    ...
    new obsidian.Setting(containerEl)
      .setName("显示根文件夹")
      .setDesc(
        `开启后,您的根文件夹 "${this.plugin.app.vault.getName()}" 将在文件树中可见`,
      )
      .addToggle((toggle) =>
        toggle
    ...
    new obsidian.Setting(containerEl)
      .setName("文件夹笔记")
      .setDesc(
        `开启此选项后,可以像文件夹笔记插件一样创建文件夹笔记。
                默认情况下,单击将打开文件列表。您需要使用 "Shift+单击" 来打开文件夹笔记。如果文件夹有文件夹笔记,
                您将在文件夹右侧看到一个箭头图标。作为文件夹笔记创建的笔记在文件列表中是隐藏的。`,
      )
      .addToggle((toggle) => {
    ...
    new obsidian.Setting(containerEl)
      .setName("在文件列表中包含子文件夹文件")
      .setDesc(
        `开启此项后,除了选定的文件夹外,还可以查看所有子文件夹中的文件列表`,
      )
      .addToggle((toggle) =>
        toggle
    ...
    new obsidian.Setting(containerEl)
      ...
      .setDesc(
        `开启此项后,将在文件列表顶部添加一个额外的按钮来切换 "包含子文件夹文件"`,
      )
      .addToggle((toggle) =>
        toggle
          .setValue(this.plugin.settings.showFilesFromSubFoldersButton)
          .onChange((value) => {
    ...
    new obsidian.Setting(containerEl)
      .setName("在文件树中显示当前文件按钮")
      .setDesc(
        `开启此项后,将添加一个额外的按钮来在文件树中显示当前文件。它将相应地设置文件夹和文件面板。`,
      )
      .addToggle((toggle) =>
        toggle
          .setValue(this.plugin.settings.revealActiveFileButton)
          .onChange((value) => {
    ...
    new obsidian.Setting(containerEl)
      .setName("在聚焦文件夹中进行 All 和 Tag 搜索")
      .setDesc(
        `"all:" 和 "tag:" 搜索默认会在您的 vault 中查找所有文件。开启此项后,仅在聚焦文件夹中进行搜索`,
      )
      .addToggle((toggle) =>
        toggle
          .setValue(this.plugin.settings.allSearchOnlyInFocusedFolder)
          .onChange((value) => {
    ...
    new obsidian.Setting(containerEl)
      .setName("文件名前显示图标")
      .setDesc("开启后将在文件列表中的文件名前显示文件图标。")
      .addToggle((toggle) =>
        toggle
          .setValue(this.plugin.settings.iconBeforeFileName)
          .onChange((value) => {
    ...
    new obsidian.Setting(containerEl)
      .setName("悬停预览文件")
      .setDesc(
        "开启后,在文件列表中按住 Ctrl/Cmd 按钮悬停在文件上时可以预览文件。",
      )
      .addToggle((toggle) =>
        toggle
    ...
    new obsidian.Setting(containerEl)
      ...
      .setDesc("开启后,按钮和标题不会随文件列表滚动。")
      .addToggle((toggle) =>
        toggle
          .setValue(this.plugin.settings.fixedHeaderInFileList)
          .onChange((value) => {
    ...
    new obsidian.Setting(containerEl)
      .setName("显示文件完整路径")
      .setDesc("开启后,将在文件名列表中显示完整路径,而不仅仅是文件名")
      .addToggle((toggle) => {
        toggle
          .setValue(this.plugin.settings.showFileNameAsFullPath)
          .onChange((value) => {
    ...
    containerEl.createEl("p", {
      text: "以下设置仅在使用插件文件面板中的加号 (+) 按钮时适用。",
    });
    new obsidian.Setting(containerEl)
      .setName("在 YAML 中包含创建时间")
      .setDesc("开启后,插件将在文件中包含创建时间的 YAML 键")
      .addToggle((toggle) => {
    ...
    new obsidian.Setting(containerEl)
      .setName("将文件名设置为标题 1")
      .setDesc("开启后,插件将在创建的文件中将初始文件名添加为主标题。")
      .addToggle((toggle) => {
        toggle
          .setValue(this.plugin.settings.fileNameIsHeader)
          .onChange((value) => {
    ...
    new obsidian.Setting(containerEl)
      .setName("隐藏附件")
      .setDesc(
        `这将从视图中隐藏 "attachments" 文件夹,并在文件列表中隐藏该文件夹下的任何文件`,
      )
      .addToggle((toggle) =>
        toggle
    ...
    new obsidian.Setting(containerEl)
      .setName("排除的文件扩展名")
      .setDesc(
        `提供要从文件树列表中排除的文件扩展名,用逗号分隔。例如:'png, pdf, jpeg'。
            您需要重新加载 vault 或使用下面的 "重新加载文件树" 按钮使更改生效。`,
      )
      .addTextArea((text) =>
        text
    ...
    new obsidian.Setting(containerEl)
      .setName("排除的文件夹路径")
      .setDesc(
        `提供要从文件树列表中排除的文件夹完整路径,用逗号分隔。例如:'Personal/Attachments, Work/Documents/Folders'。
            所有子文件夹也将被排除。您需要重新加载 vault 或使用下面的 "重新加载文件树" 按钮使更改生效。`,
      )
      .addTextArea((text) =>
        text
    ...
    new obsidian.Setting(containerEl)
      .setDesc(
        "使用此按钮重新加载文件树。某些设置需要重新加载文件树。您也可以重新启动您的 vault 以达到相同的效果。",
      )
      .addButton((button) => {
        button
    ...
    new obsidian.Setting(containerEl)
      .setName("清除所有缓存数据")
      .setDesc(
        `此按钮将清除以下缓存数据:"分隔符的最后位置"、"文件夹面板中已展开文件夹的列表"和"最后活动的文件夹路径"。它不会影响上面的设置和已固定的文件列表。建议偶尔执行此清除操作。`,
      )
      .addButton((button) => {
        button
          ...
          .onClick(() =>
            __awaiter(this, void 0, void 0, function* () {
              lsh.removeFromLocalStorage({
                key: this.plugin.keys.customHeightKey,
              });
              lsh.removeFromLocalStorage({
                key: this.plugin.keys.customWidthKey,
              });
              lsh.removeFromLocalStorage({
                key: this.plugin.keys.openFoldersKey,
              });
              lsh.removeFromLocalStorage({
                key: this.plugin.keys.activeFolderPathKey,
              });
              lsh.removeFromLocalStorage({
                key: this.plugin.keys.focusedFolder,
              });
              this.plugin.refreshTreeLeafs();
              new obsidian.Notice("插件缓存已清除...");
            }),
          );
      });
    new obsidian.Setting(containerEl)
      .setName("清除已固定的文件")
      .setDesc(`此按钮将清除文件列表面板中已固定的文件。`)
      .addButton((button) => {
        button
          .setTooltip("点击此处清除已固定的文件")
          .setButtonText("清除已固定的文件")
          .onClick(() =>
            __awaiter(this, void 0, void 0, function* () {
              lsh.removeFromLocalStorage({
                key: this.plugin.keys.pinnedFilesKey,
              });
              this.plugin.refreshTreeLeafs();
              new obsidian.Notice("已固定的文件已清除...");
            }),
          );
      });
  }
...
class FileTreeAlternativePlugin extends obsidian.Plugin {
  constructor() {
    ...
    this.bookmarksAddEventListener = () => {
      ...
      if (bookmarkLeafElement) {
        bookmarkLeafElement.addEventListener(
          "click",
          this.bookmarksEventHandler,
          true,
        );
      }
    };
    this.bookmarksRemoveEventListener = () => {
      let bookmarkLeafElement = this.getBookmarksLeafElement();
      if (bookmarkLeafElement) {
        bookmarkLeafElement.removeEventListener(
          "click",
          this.bookmarksEventHandler,
          true,
        );
  ...
  onload() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      // Load Settings
      this.addSettingTab(
        new FileTreeAlternativePluginSettingsTab(this.app, this),
      );
      ...
      this.addCommand({
        ...
        callback: () =>
          __awaiter(this, void 0, void 0, function* () {
            return yield this.openFileTreeLeaf(true);
          }),
      });
      this.app.workspace.onLayoutReady(() => {
